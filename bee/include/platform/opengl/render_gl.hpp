...
class Renderer : public System, public IPanel, public IEntityInspector, public IStatsBar
{
public:
    Renderer();
    ~Renderer() override;
...
public:
    ...
    std::string GetIcon() const override { return ICON_FA_CAMERA; }
...
BEE_VISITABLE_STRUCT(bee::DebugData, BaseColor, Normals, NormalMap, Metallic, Roughness, Emissive, Occlusion);
