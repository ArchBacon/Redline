...
public:
    ...
    enum class GamepadButton
    {
        ...
        /// This button has different names on different platforms, such as Share (Xbox) or - (Switch).
        MenuLeft = 6,
        /// Represents the right of the two menu-related buttons on a gamepad.
        /// This button has different names on different platforms, such as Menu (Xbox), or + (Switch).
        MenuRight = 7,
    ...
    /// Shows or hides the mouse cursor, if applicable.
