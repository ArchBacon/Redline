...
public:
    ...
    /// out).</returns>
    Navmesh(const geometry2d::PolygonList& walkableAreas, const geometry2d::PolygonList& obstacles, float agentRadius);
    ...
    inline const geometry2d::PolygonList& GetPolygons() const { return m_polygons; }
    inline const graph::EuclideanGraph& GetGraph() const { return m_graph; }
...
private:
    ...
    static geometry2d::PolygonList CleanupGeometry(const geometry2d::PolygonList& walkableAreas,
                                                   const geometry2d::PolygonList& obstacles,
                                                   float radius);
