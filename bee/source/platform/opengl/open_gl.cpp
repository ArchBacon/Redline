...
DebugCallbackFunc(GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei, const GLchar* message, const GLvoid*)
{
...
static void APIENTRY
DebugCallbackFuncAMD(GLuint id, GLenum category, GLenum severity, GLsizei length, const GLchar* message, void* userParam)
{
    DebugCallbackFunc(GL_DEBUG_CATEGORY_API_ERROR_AMD, category, id, severity, length, message, userParam);
}

template <typename T>
T GetGlProcAddress(const char* name)
{
...
{
    auto _glDebugMessageCallback = GetGlProcAddress<PFNGLDEBUGMESSAGECALLBACKPROC>("glDebugMessageCallback");
    auto _glDebugMessageCallbackARB = GetGlProcAddress<PFNGLDEBUGMESSAGECALLBACKARBPROC>("glDebugMessageCallbackARB");
    auto _glDebugMessageCallbackAMD = GetGlProcAddress<PFNGLDEBUGMESSAGECALLBACKAMDPROC>("glDebugMessageCallbackAMD");
